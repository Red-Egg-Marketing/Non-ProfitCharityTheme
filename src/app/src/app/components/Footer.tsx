...
export function Footer() {
  ...
  const programs = [
    {
      ...
      href: "https://www.milehighbehavioralhealthcare.org/",
    },
    {
      label: "Family Preservation Center",
      href: "https://www.milehighbehavioralhealthcare.org/",
    },
    {
      label: "Housing & Crisis Support",
      href: "https://www.milehighbehavioralhealthcare.org/",
    },
    {
      label: "LGBTQ2S+ Services",
      href: "https://www.milehighbehavioralhealthcare.org/",
    },
    {
  ...
  const resources = [
    {
      label: "Donate via Colorado Gives",
      href: "https://www.coloradogives.org/donate/MHBHC",
    },
    {
      label: "Volunteer Opportunities",
      href: "mailto:info@mhbhc.org",
    },
    {
  ...
  const socialLinks = [
    {
      icon: Facebook,
      href: "https://www.facebook.com/MileHighBehavioralHealthCare",
      label: "Facebook",
    },
    {
      icon: Instagram,
      href: "https://www.instagram.com/milehighbehavioralhealthcare/",
      label: "Instagram",
    },
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/company/mile-high-behavioral-health-care/",
      label: "LinkedIn",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/70 leading-relaxed text-sm">
              To provide a caring, seamless continuum of
              behavioral healthcare to those in need — across
              Denver, Sheridan, Aurora, and Summit County.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm text-white/70">
                ...
                <a
                  href="mailto:info@mhbhc.org"
                  className="hover:text-[#25a794] transition-colors"
                >
                  info@mhbhc.org
                </a>
              </div>
        ...
        <div className="max-w-[1440px] mx-auto px-10 lg:px-20 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-white/50">
              © 2026 Mile High Behavioral Health Care. All
              rights reserved. A 501(c)(3) nonprofit
              organization.
            </p>
